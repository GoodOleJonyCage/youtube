...
export const Sidebar = () => {
    ...
    return <div className="sidebar">
        ...
        <div>
            <span class="material-icons-outlined">sports_handball</span>
            <label>Gaming</label>
        </div>
        <div>
            <span class="material-icons-outlined">closed_caption_off</span>
        ...
        <div>
            <span class="material-icons-outlined">sports_mma</span>
            <label>Sports</label>
        </div>
        <div className="separator"></div>
        <div>
